...
runs entirely in the browser against seeded, deterministic mock data (10
branches, ~104 employees, evaluations, disciplinary records, audit logs,
announcements) so it can be demoed immediately without any setup.
...
preview the system from that role's point of view (HR Administrator, Payroll
Officer, Sr. Accounting Assistant, Corporate Treasurer, CFO, Department Head,
Employee, Upper Management, Freelancer, System Administrator).
...
pass: **Dashboards, Contract Monitoring, Performance Evaluations, Disciplinary
Records, Audit Trail, and System Administration**, plus the foundation every
module needs (Employee Directory / 201 File, Org structure, Bulletin Board,
...
Payslips, Allowance Vouchers, Government Reports, 13th Month Pay, Payroll
Reports, Notifications, Org Chart — are present in the navigation as clearly
labeled **"Preview"** stubs describing what's planned, so the full scope of
the spec is visible even though depth wasn't built into every module yet.
